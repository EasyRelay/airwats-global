        ...
        <article className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using the services provided by AirWays Transportation LLC (MC: 1692095, DOT: 4333195), you agree
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              AirWays Transportation LLC provides logistics and freight transportation services, including:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              AirWays Transportation LLC maintains comprehensive cargo insurance and operates in full compliance with federal
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To the maximum extent permitted by law, AirWays Transportation LLC shall not be liable for any indirect,
